...
const typeNum = (arr) => {
  // Solution code here...
  let newArry = arr.filter( item => (typeof(item)==='number'));
  return newArry;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let newArry = arr.filter(item => item.includes('and'));
  return newArry;
};
...
const oddValues = (arr) => {
  // Solution code here...
  let newArry = arr.filter(num => (num % 2));
  return newArry;
};
...
const filterStringsWithVowels = (arr) => {
  // Solution code here...
  let newArry = arr.filter(item => /[aeiou]/.test(item)); //aeiou are the vowels
  return newArry;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let newArry = arr.filter(num => !(forbiddenValues.includes(num)));
  return newArry;
};
